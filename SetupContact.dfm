object Form2: TForm2
  ...
  inline Frame21: TFrame2
    ...
    inherited EditAbsenderPLZ: TEdit
      StyleElements = [seFont, seClient, seBorder]
    end
    inherited EditAbsenderOrt: TEdit
      StyleElements = [seFont, seClient, seBorder]
    end
    inherited EditAbsenderStraße: TEdit
      StyleElements = [seFont, seClient, seBorder]
    end
  end
  ...
  object OpenDialog1: TOpenDialog
    Filter = 'vCard|*.vcf|(Veraltet) Windows-Kontaktdatei|*.contact'
    Options = [ofHideReadOnly, ofEnableSizing, ofDontAddToRecent]
    Title = #214'ffnen einer vCard'
    Left = 280
    Top = 304
  end
end
